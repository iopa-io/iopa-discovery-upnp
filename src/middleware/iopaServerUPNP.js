...
const constants = iopa.constants,
  ...
  UPNPDISCOVERY = require('../common/constants.js').UPNPDISCOVERY
 ...
 */
IopaServerUPNP.prototype.invoke = function IopaServerUPNP_invoke(context, next) {
 ...
 * @param next the next IOPA AppFunc in pipeline 
 */
IopaServerUPNP.prototype.invokeDEVICEGET = function IopaServerUPNP_invokeGET(context, next) {
 ...
 * @param next the next IOPA AppFunc in pipeline 
 */
IopaServerUPNP.prototype.invokeMSEARCH = function IopaServerUPNP_invokeMSEARCH(context, next) {
...
*/
IopaServerUPNP.prototype.register = function IopaServerUPNP_register(nextRegister, device) {
 var self = this;
...
* @param device the device context defaults  
*/
IopaServerUPNP.prototype._notify = function IopaServerUPNP_notify(device) {
 ...
 * @param device the device context defaults  
 */
IopaServerUPNP.prototype.unregister = function IopaServerUPNP_unregister(nextUnregister, id) {
   var device = this._devices[id];
...
* @this DiscoveryServerIopaWire 
*/
IopaServerUPNP.prototype._ensureListening = function IopaServerUPNP_ensureListening() {
  var that = this;
  if (!this._SSDPserver) {    
